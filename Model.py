...
def create_model(X_train, y_train,X_val, y_val, learning_rate=0.005, extra_weight=1, improvement="", threshold_method=None, l2_reg=False, lambda_const=None, to_print=False, score_f1 = None):
